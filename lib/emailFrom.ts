export const RETAIL_FROM_EMAIL =
  process.env.RETAIL_FROM_EMAIL || "Herbal Communities <retail@herbalcommunities.com>";

export const WHOLESALE_FROM_EMAIL =
  process.env.WHOLESALE_FROM_EMAIL || "Herbal Communities Wholesale <wholesale@herbalcommunities.com>";

export const RETREATS_FROM_EMAIL =
  process.env.RETREATS_FROM_EMAIL || "Herbal Communities Retreats <retreats@herbalcommunities.com>";
